...
const T = {
  "zh-CN": {
    ...
    chooseRole: "选择你的身份",
    roleProject: "创作者发布需求",
    roleProjectDesc: "我是内容创作者 / 独立创作者，想发布需求、管理内容",
    roleParticipant: "参与者",
    roleParticipantDesc: "我是开发者 / 社区用户，想浏览公告、订阅内容、申请机会",
    fillInfo: "填写信息",
    projectName: "创作者名称",
    projectNamePh: "请输入创作者名称",
  ...
  en: {
    ...
    roleProject: "Creator (Post Demands)",
    roleProjectDesc: "I'm a creator — I want to post demands and manage content",
    ...
    projectNamePh: "Enter your creator name",
