...
export const DEFAULT_KEYWORDS = [
  ...
  // Analytics keywords
  "on-chain data","blockchain analytics","chain analysis","wallet tracking","whale alert",
  "market sentiment","fear greed","nansen","glassnode","dune analytics","token terminal",
  "defillama","messari","coingecko","intotheblock","arkham","lookonchain",
  ...
  "链上数据","数据分析","鲸鱼监控","市场情绪","协议收入","活跃地址","交易量",
  ...
  "gamefi","play to earn","p2e","play-to-earn","blockchain game","on-chain game",
